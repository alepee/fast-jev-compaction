...
import type { Judge, JevQuestions, JevResponse, JevState } from './types.js';
...
export class JevClient implements Judge {
  ...
  async judge(state: JevState, questions: JevQuestions): Promise<JevResponse> {
